class makemove:
    def makemove(self, board, move, ply, bitop, pc, color):
        if color == 0:
            sign = 1
        else:
            sign = -1
        ...
        if move.ifrom == board.square_nb:
            #駒打ちの場合
            board.board[move.ito] = sign * move.piece_to_move
            ...
            board.board[move.ifrom] = pc.empty
            if move.flag_promo == 1:
                #成る手の場合
                if move.piece_to_move == pc.pawn:
                    board.board[move.ito] = sign * pc.pro_pawn
                    ...
                    board.board[move.ito] = sign * pc.pro_lance
                    ...
                    board.board[move.ito] = sign * pc.pro_knight
                    ...
                    board.board[move.ito] = sign * pc.pro_silver
                    ...
                    board.board[move.ito] = sign * pc.horse
                    ...
                    board.board[move.ito] = sign * pc.dragon
